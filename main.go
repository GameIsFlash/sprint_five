...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (((w.meanSpeed()*KmHInMsec)*(w.meanSpeed()*KmHInMsec))/heightInMeters)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
